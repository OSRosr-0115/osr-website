...
const TEXT = {
  jp: {
    ...
    servicesLead:
      '原状回復からリフォーム、内装・外装、ハウスクリーニングまで。建物に関するさまざまなご要望に、確かな施工力と柔軟な対応力でお応えします。',
  ...
  jp: [
    {
      ...
      title: '退去立ち合い・原状回復',
      en: 'Restoration',
      desc: '退去時の立会いから、原状回復工事、クロス・床の張替え、設備交換、補修・ハウスクリーニングまで一貫して対応します。',
      image: image0,
    },
    {
      no: '02',
      title: 'リフォーム工事',
      en: 'Renovation',
      desc: 'キッチン・浴室・洗面・トイレなどの水回りから、間取り変更、内装・設備の改修まで幅広く対応します。',
      image: image1,
    },
    {
      no: '03',
      ...
      desc: 'クロス・床・建具などの内装工事をはじめ、照明・水回り・空調などの設備交換・修繕まで対応します。',
      image: image2,
    },
    {
      no: '04',
      title: '外構・エクステリア工事',
      en: 'Exterior Works',
      desc: 'フェンス・ブロック塀・門扉・駐車場・土間コンクリート・アプローチなど、建物まわりの外構工事に対応します。',
      image: image3,
    },
    {
      no: '05',
      ...
      desc: '家具・家電・生活用品などの不用品回収から、退去後や空室の残置物撤去まで対応します。',
      image: image4,
    },
    {
      no: '06',
      title: 'ハウスクリーニング',
      en: 'House Cleaning',
      desc: '退去後・入居前の清掃をはじめ、水回り・床・窓・エアコンなど幅広く対応します。',
      image: image5,
    },
  ],
...
const WHY_DATA = {
  jp: [
    ...
    ['03', '建物に関する幅広い工事に対応', '原状回復、リフォーム、内装、外装、外構、設備交換、ハウスクリーニングまで幅広く対応。小さな修繕から大規模な工事までご相談までいただけます。'],
    ['04', '迅速・柔軟な対応力', '現地調査からお見積り、施工まで、現場の状況やご要望ご要望に合わせて迅速かつ柔軟に対応します。'],
    ['05', '個人・法人・不動産管理会社まで対応', '一般住宅から店舗・法人・物件オーナー・不動産管理会社まで、それぞれの用途・予算・スケージュールに合わせてご提案します。'],
    ['06', '最後まで責任を持った現場管理', '工程・品質・安全・進歩進捗を管理し、施工後の仕上がり確認・清掃・完了報告まで責任持って対応します。'],
  ],
...
export default function App() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const response = await fetch(
      'https://na01.safelinks.protection.outlook.com/?url=https%3A%2F%2Fformspree.io%2Ff%2Fmgawovgb&data=05%7C02%7C%7Cc78f27792b0942f7b88c08defcf28f24%7C84df9e7fe9f640afb435aaaaaaaaaaaa%7C1%7C0%7C639226315867185846%7CUnknown%7CTWFpbGZsb3d8eyJFbXB0eU1hcGkiOnRydWUsIlYiOiIwLjAuMDAwMCIsIlAiOiJXaW4zMiIsIkFOIjoiTWFpbCIsIldUIjoyfQ%3D%3D%7C0%7C%7C%7C&sdata=08jvIlbp4As9ZlveJAEN12N7jH2JezFJYt9tEGkjtsQ%3D&reserved=0',
      {
        method: 'POST',
